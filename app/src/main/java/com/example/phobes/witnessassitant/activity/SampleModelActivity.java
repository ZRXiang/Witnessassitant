...
public class SampleModelActivity extends AppCompatActivity {
    ...
    private final int MODEL_REQ_CODE = 1;
    ...
    private void addEvents() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              //  Intent intent = new Intent(SampleModelActivity.this, MainActivity.class);  //yang  160921
...
//TODO
    ...
    private void openQr(){
        Intent intent = new Intent(SampleModelActivity.this,CaptureActivity.class);
      //  intent.putExtra("operation","inRoom");  yang  160922
        intent.putExtra("operation","sampleModel");
        startActivityForResult(intent,MODEL_REQ_CODE);
    }
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(SampleModelActivity.this)
                .setMessage(message)
    ...
    private void getBack(){
        Intent intent = new Intent(SampleModelActivity.this,MainActivity.class);
        startActivity(intent);
        finish();
    }
    @Override
    ...
    private void initViews() {
        ...
        if (toolbar != null) {
            toolbar.setTitle(SampleModelActivity.this.getResources().getString(R.string.sample_split_model_button));
        }
    ...
    private void upload() {
        ...
        if (commService.isNetConnected()) {
            ...
            Snackbar.make(tvStrength, "没有网络，请在网络通畅的时候进行拆模上报", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }
    }
    ...
    public class UploadWitness extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                String result = CommData.dbWeb.sampleModel(CommData.username, DateUtil.DateTimeToString(new Date()), orgId, noticeId, sampleId);
