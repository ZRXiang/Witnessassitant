...
public class InRoomActivity extends AppCompatActivity {
    ...
    public int errorTag;
    private final int IN_ROOM_REQ_CODE = 2;
    ...
    private void findViewById() {
        ...
        tvPosition=(EditText) findViewById(R.id.position);
        ...
        btOk.setOnClickListener(new View.OnClickListener() {
            ...
            //                    attmpUpload();
                ...
                if(TextUtils.isEmpty(position)){
                    tvPosition.setError(getString(R.string.error_field_required));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        try {
            errorTag = data.getIntExtra(SampleProductActivity.ERROR_SCAN, 0);
            if (errorTag == 1) {
    ...
    private void initViews() {
        ...
        if (toolbar != null) {
            toolbar.setTitle(InRoomActivity.this.getResources().getString(R.string.in_room_button));
        }
...
//TODO
    ...
    private void openQr(){
        Intent intent = new Intent(InRoomActivity.this,CaptureActivity.class);
        intent.putExtra("operation","inRoom");
        startActivityForResult(intent,IN_ROOM_REQ_CODE);
    }
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(InRoomActivity.this)
                .setMessage(message)
    ...
    private void getBack(){
        Intent intent = new Intent(InRoomActivity.this,MainActivity.class);
    ...
    private void upload() {
        ...
        if (commService.isNetConnected()) {
            ...
            Snackbar.make(tvStrength, "没有网络，请在网络通畅的时候进行入库上报", Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
        }
    }
    ...
    public class UploadWitness extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            try {
                String result = CommData.dbWeb.inRoomWitness(CommData.username, DateUtil.DateTimeToString(new Date()), orgId, noticeId, sampleId,position);
